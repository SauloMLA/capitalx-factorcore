...
*   `[/]` **Infrastructure:** Configuración física de `src/`, diseño de módulos, e inicialización de NestJS y base de datos local SQLite con Prisma.
*   `[ ]` **Implementation:** Escritura de entidades, Value Objects, casos de uso y adaptadores.
